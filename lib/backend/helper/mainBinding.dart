...
import 'package:getx_model/view/test/test_state.dart';
...
class MainBinding extends Bindings {
  ...
  Future<void> dependencies() async {
    ...
    Get.lazyPut(() => TestState(apiService: Get.find(),sharedPreferencesManager: Get.find(),socketService : Get.find()), fenix: true);
  }
}
